...
const features = [
    { name: 'Origins', description: 'Designed by Good Goods, Inc.' },
    { name: 'Materials', description: 'Solid walnut base with rare earth magnets and powder coated steel card cover' },
    { name: 'Dimensionss', description: '6.25" x 3.55" x 1.15"' },
    { name: 'Finishs', description: 'Hand sanded and finished with natural oil' },
    { name: 'Includess', description: 'Wood card tray and 3 refill packs' },
    { name: 'Considerationss', description: 'Made from natural materials. Grain and color vary with each item.' },
