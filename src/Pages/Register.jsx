                    ...
                    <div className="margin-top-postion p-12 bg-white mx-auto rounded-3xl w-96 ">
                        <div className="mb-7">
                            ...
                            <p className="text-gray-400">
                                ...
                                <Link to="/login" className="text-sm text-purple-700 hover:text-purple-700">Sign In</Link>
                            </p>
                        </div>
                        <div className="space-y-6">
                            <div className="">
                                <input className=" w-full text-sm  px-4 py-3 bg-gray-200 text-gray-800 focus:bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:border-purple-400 mt-2 mb-2" type="text" placeholder="Full Name" />
                                ...
                                <div className="relative" x-data="{ show: true }">
                                    <input placeholder="Confirm Password" type="show ? 'password' : 'text'" className="text-sm text-gray-800 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400 mt-2 mb-2" />
                                    <div className="flex items-center absolute inset-y-0 right-0 mr-3  text-sm leading-5">
                                ...
                                <div class="flex items-center pt-2 pb-1">
                                    ...
                                    <label for="filter-mobile-color-0" class="ml-3 min-w-0 flex-1 text-gray-500 text-size">Also Subscribe for SEO News & tools updates.</label>
                                </div>
                                <div class="flex items-center pt-1 pb-2">
                                    <input id="filter-mobile-color-1" name="color[]" value="white" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                    <label for="filter-mobile-color-1" class="ml-3 min-w-0 flex-1 text-gray-500 text-size">I agree to all the Terms Privacy Policy and Refund Policy</label>
                                </div>
